...
sealed class XMLRegistry permits Object2XML, XML2Object {
    ...
    public void registerClass(Class<?> clazz) throws ReflectiveOperationException {
        ...
        if (annotation == null) throw new IllegalArgumentException("You have to declare " + XMLClass.class);
        ...
        classToConstructor.put(clazz, ReflectUtils.toRawConstructor(constructor));
    }
}
